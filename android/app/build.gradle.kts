...
// Загрузка ключей подписи из key.properties (не попадает в git).
...
android {
    namespace = "ru.hunterapp.pomoshchnik_okhotnika"
    ...
    defaultConfig {
        applicationId = "ru.hunterapp.pomoshchnik_okhotnika"
